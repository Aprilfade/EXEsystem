...
详见：[v3.06版本更新总结](document/v3.06版本更新总结.md)
...
### ✨ v3.06 重大更新亮点（2026-03-06）

1. **🤖 AI监控增强**
   - CSV格式导出AI调用日志
   - 支持时间范围筛选
   - Excel直接打开无乱码（UTF-8 BOM）
   - 完整字段导出：响应时间、Token使用量、成本等
...
- **学习分析报告**：AI生成个性化学习建议
- **AI监控系统**：API调用监控、成本统计、CSV导出、性能分析 ⭐v3.06
- **智能课程推荐**：基于考试成绩的个性化课程推荐 ⭐v3.06
- **智能搜索**：课程名称和描述相关度匹配 ⭐v3.06
...
```bash
git clone https://github.com/Aprilfade/EXEsystem.git
cd EXEsystem
```
...
### v3.06 (2026-03-06)
- ✅ **AI监控增强**：CSV导出功能，支持时间筛选和完整字段导出
- ✅ **智能课程推荐**：基于考试成绩分析薄弱科目，推荐相应课程
- ✅ **课程搜索实现**：智能相关度匹配，按相关度排序
- ✅ **用户认证优化**：获取真实用户ID，完善审计追踪
- ✅ **登出流程统一**：教师端和学生端统一跳转到Portal页面
- ✅ **代码质量提升**：完成所有TODO项，优化代码结构
- 📚 **完整文档**：[v3.06版本更新总结](document/v3.06版本更新总结.md)
...
- **版权所有** © 2026 EXEsystem Team
- 本软件已申请中华人民共和国软件著作权保护
- 允许根据 MIT 许可证条款自由使用、修改和分发
- 使用时请保留原作者版权声明
...
**注意**：虽然代码开源，但软件著作权仍归原作者所有，受中华人民共和国著作权法保护
