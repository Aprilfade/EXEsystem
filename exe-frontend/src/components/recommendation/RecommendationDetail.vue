<template>
  <div class="recommendation-explanation">
    ...
    <el-tabs v-model="activeTab" class="detail-tabs">
      ...
      <el-tab-pane label="推荐解释" name="explanation">
        <!-- 原有的推荐解释内容 -->
        <recommendation-explanation-content :recommendation="recommendation" />
      </el-tab-pane>
    </el-tabs>
  </div>
</template>
...
import RecommendationExplanationContent from './RecommendationExplanationContent.vue'
...
<!-- 将原有的推荐解释部分移到新组件 RecommendationExplanationContent.vue -->
<template v-if="false">
  <div class="original-explanation-content">
    <!-- 推荐算法可视化 -->
